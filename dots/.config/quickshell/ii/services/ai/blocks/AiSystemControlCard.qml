    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: Translation.tr("Apply this system change?")
                    wrapMode: Text.Wrap
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: Translation.tr("Undo: %1").arg(String(root.preview.previousSummary ?? ""))
                    wrapMode: Text.Wrap
                    font.pixelSize: Appearance.font.pixelSize.smaller
                    color: Appearance.m3colors.m3onSecondaryContainer
                }
        ...
        RowLayout {
            ...
            RippleButton {
                ...
                onClicked: Ai.rejectSystemControl(root.messageData)
            ...
            RippleButtonE {
                ...
                onClicked: Ai.approveSystemControl(root.messageData)
                contentItem: StyledText {
