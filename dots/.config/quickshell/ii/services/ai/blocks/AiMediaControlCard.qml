...
/** Shows the active player and playback action before applying it. */
Rectangle {
    id: root
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: Translation.tr("Change playback?")
                    wrapMode: Text.Wrap
        ...
        RowLayout {
            ...
            RippleButton {
                ...
                onClicked: Ai.rejectMediaControl(root.messageData)
            ...
            RippleButtonE {
                ...
                onClicked: Ai.approveMediaControl(root.messageData)
                contentItem: StyledText {
