...
/** Shows the exact local wallpaper thumbnail before a reviewed theme change. */
Rectangle {
    id: root
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Image {
                Layout.preferredWidth: Appearance.font.pixelSize.huge * 3
                Layout.preferredHeight: Appearance.font.pixelSize.huge * 2
                fillMode: Image.PreserveAspectCrop
                source: String(root.preview.thumbnail ?? "")
                asynchronous: true
                smooth: true
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: Translation.tr("Undo: %1").arg(String(root.preview.previousRef ?? Translation.tr("current wallpaper")))
                    wrapMode: Text.Wrap
                    font.pixelSize: Appearance.font.pixelSize.smaller
                    color: Appearance.m3colors.m3onSecondaryContainer
                }
        ...
        RowLayout {
            ...
            RippleButton {
                ...
                onClicked: Ai.rejectWallpaperSet(root.messageData)
            ...
            RippleButtonE {
                ...
                onClicked: Ai.approveWallpaperSet(root.messageData)
                contentItem: StyledText {
