...
/** Shows the exact note destination and bounded Markdown before a write. */
Rectangle {
    id: root
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: root.preview.operation === "create"
                        ? Translation.tr("Create this note?")
                        : Translation.tr("Append to this note?")
                    wrapMode: Text.Wrap
                ...
                StyledText {
                    Layout.fillWidth: true
                    text: String(root.preview.destination ?? "")
                    wrapMode: Text.Wrap
        ...
        RowLayout {
            ...
            RippleButton {
                ...
                onClicked: Ai.rejectNotes(root.messageData)
            ...
            RippleButtonE {
                ...
                onClicked: Ai.approveNotes(root.messageData)
