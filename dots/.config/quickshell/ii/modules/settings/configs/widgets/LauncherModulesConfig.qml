    ...
    ContentPage {
        ...
        ContentSection {
            ...
            ColumnLayout {
                Layout.fillWidth: true
                spacing: Appearance.sizes.elevationMargin / 2
                ConfigSwitch { buttonIcon: "menu_book"; text: Translation.tr("Cheat Sheet shortcuts");                 description: Translation.tr("Lets Search open Cheat Sheet pages such as elements, amino acids, workspaces, and commands."); checked: Config.options.search.modules.cheatsheet.enable; onCheckedChanged: Config.options.search.modules.cheatsheet.enable = checked }
